...
self.ask = BestOrderAsk(
    ask_exchange.markets[settings["market"]],
    ask_exchange,
    trade["expected"]["ask"]["order_book"],
)
self.bid = BestOrderBid(
    bid_exchange.markets[settings["market"]],
    bid_exchange,
    trade["expected"]["bid"]["order_book"],
)
